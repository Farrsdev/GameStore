...
<head>
    <meta charset="UTF-8">
    <title>Edit Genre | Farr'sStore Admin</title>
        ...
        <div class="card">
            <form action="{{ route('admin.genres.update', $genre->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" id="name" class="form-control" placeholder="e.g., Action, RPG, Sports" value="{{ old('name', $genre->name) }}" required>
                    @error('name')
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" id="description" class="form-control" placeholder="Brief description about this genre">{{ old('description', $genre->description) }}</textarea>
                    @error('description')
                        <div class="error-message">{{ $message }}</div>
                    @enderror
                </div>
